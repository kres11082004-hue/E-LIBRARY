    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6 print:hidden">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">Comprehensive library system report ΓÇö printable</p>
        </div>
                ...
                <tbody>
                  {borrows.map((record, i) => (
                    <tr key={record.id} className={i % 2 === 0 ? "bg-white print:bg-white" : "bg-muted/20 print:bg-gray-50"}>
                      ...
                      <td className="px-3 py-2 border border-border print:border-gray-300 font-medium">{record.user?.fullname ?? "ΓÇö"}</td>
                      <td className="px-3 py-2 border border-border print:border-gray-300 text-muted-foreground print:text-gray-600 text-xs">{record.user?.campus ?? "ΓÇö"}</td>
                      <td className="px-3 py-2 border border-border print:border-gray-300">{record.book?.title ?? "ΓÇö"}</td>
                      <td className="px-3 py-2 border border-border print:border-gray-300 text-muted-foreground print:text-gray-600">
                        {record.borrowedAt ? new Date(record.borrowedAt).toLocaleDateString("en-PH") : "ΓÇö"}
                      </td>
                      <td className="px-3 py-2 border border-border print:border-gray-300 text-muted-foreground print:text-gray-600">
                        {record.dueDate ? new Date(record.dueDate).toLocaleDateString("en-PH") : "ΓÇö"}
                      </td>
                ...
                <tbody>
                  {byCourse.map((row, i) => (
                    <tr key={i} className={i % 2 === 0 ? "bg-white print:bg-white" : "bg-muted/20 print:bg-gray-50"}>
                      ...
                      <td className="px-3 py-2 border border-border print:border-gray-300 text-muted-foreground print:text-gray-600">{row.year} ΓÇö Sec {row.section}</td>
